...
class TableQuestions extends React.PureComponent {
    ...
    async componentDidMount(){
        ...
        try{
            ...
            baseURL+'api/ques/userProfileQues/'+localStorage.getItem('username')+'/', {
        ...
        for(let i = 0; i < gresult.data.length ; i++)
        {
            ...
            {quesID:gresult.data[i].questionTranslationID , date:gresult.data[i].modified_on,
            ...
            <TableBody>
             {this.state.getValue
                ...
                <TableRow key={row.quesID}>
                  ...
                  <TableCell align="left">The question {row.caption} was modified on {row.date}.</TableCell>
                </TableRow>
             )})}
