...
export const quesString = [{ name:"Question", question: "", imgs:[] },
                          { name:"Answer Explanation", question: "", imgs:[] }];

export const quesInfo = [
  { name: "Language", detail: "" }, //0
  { name: "Caption", detail: "" },  //1
  { name: "Identifier", detail: "" }, //2
];
    ...
    return (
      <React.Fragment>
        ...
        <Grid container spacing={2}>
         <Grid item xs={12}>
            <Typography gutterBottom>{quesInfo[1].detail}</Typography>
