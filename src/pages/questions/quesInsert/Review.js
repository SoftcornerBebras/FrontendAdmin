...
export const quesString = [{ name:"Question", question: null },
                          { name:"Answer Explanation", question: null }];
  ...
  return (
   <React.Fragment>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12}>
          <Typography gutterBottom>{quesInfo[2].detail}</Typography>
